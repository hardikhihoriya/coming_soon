                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="team-member">
                                    <figure>
                                        <img src="images/team/Hardik_Hihoriya.JPG" alt="Team Member">
                                        <figcaption>
                                            <p class="member-name">
                                                Hardik Hihoriya
                                            </p>
                ...
                <div class="container">
                    ...
                    <form id="contact-form" method="post" class="clearfix">
                        <div class="contact-box-hide">
                            ...
                            <div class="col-sm-2">
                                <button class="btn custom-btn col-xs-12" type="submit" name="submit"><i class="fa fa-rocket"></i></button>
                                <span id="contact-loading" class="btn custom-btn col-xs-12"> <i class="fa fa-refresh fa-spin"></i> </span>
                            </div>
                        </div><!-- /.contact-box-hide -->
                        <div class="contact-message" id="msg"></div>
                    </form>
